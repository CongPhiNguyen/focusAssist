...
class song6 extends StatefulWidget {
  @override
  _song6State createState() => _song6State();
}

class _song6State extends State<song6>  with TickerProviderStateMixin {
   _song6State(){}
  @override
 void initState() {
    super.initState();
