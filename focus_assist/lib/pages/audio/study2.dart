...
class song7 extends StatefulWidget {
  @override
  _song7State createState() => _song7State();
}

class _song7State extends State<song7>  with TickerProviderStateMixin {
   _song7State(){}
  @override
 void initState() {
    super.initState();
